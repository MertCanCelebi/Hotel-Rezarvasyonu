        ...
        <ScrollView style={styles.container}>
            ...
            {hotelsData.map((item) => (
                <View key={item.HotelId} style={styles.hotelItem}>
                    ...
                    <TouchableOpacity
                        onPress={() => removeFavoriteHotel(item.HotelId)}
                        style={styles.removeButton}
                    >
                        <Text style={styles.removeButton}>Favorilerden Kaldır</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        onPress={() => navigation.reset({
                            index: 0,
                            routes: [{ name: 'MakeReservationScreen',
                            params: {       
                        ...
                        <Text style={styles.removeButton}>Rezervasyon Yap</Text>
                    </TouchableOpacity>
                </View>
            ))}
        </ScrollView>
